...
class CallBackVerification_(object):
    ...
    def ver_test(self, backbone: torch.nn.Module, global_step: int):
        ...
        for i in range(len(self.ver_list)):
            ...
            print(f"XNorm: {self.ver_name_list[i], global_step, xnorm}")
            print(f'Accuracy-Flip: {self.ver_name_list[i], global_step, acc2, std2}')
            ...
            print(f'Accuracy-Highest: {self.ver_name_list[i], global_step, self.highest_acc_list[i]}')
            results.append(acc2)
